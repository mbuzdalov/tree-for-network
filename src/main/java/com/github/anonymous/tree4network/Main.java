package com.github.anonymous.tree4network;

import com.github.anonymous.tree4network.algo.*;
import com.github.anonymous.tree4network.io.GraphFromCSV;
import com.github.anonymous.tree4network.mut.*;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try (PrintWriter log = new PrintWriter(new FileWriter("log.csv"), true)) {
            for (File test : tests) {
                ...
                System.out.println(test.getName() + ": " + graph.nVertices() + ", " + graph.nEdges());
